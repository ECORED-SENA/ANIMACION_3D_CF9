...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    div.tema2-div2.pt-5
      ...
      p.mb-5 Para llevar el personaje riggeado, a un nuevo escenario, lo primero que se debe realizar es la integración en una sola colección, de todos los elementos y colecciones que lo componen. En los siguientes videos se ve cómo hacerlo eficientemente:

      .tema1-TabsA.mb-5    
        TabsA.color-acento-botones
          .tarjeta.p-4(titulo="Integrando archivos blend")
            h4.mb-4 Integrando archivos blend en el escenario
            figure
              .video
    ...
    div.p-0.d-flex.align-items-center.mb-5(style="position:relative")
      div.px-5(style="position:absolute; width:100%")
        .row.tema1-div-1-2.px-5.py-4
          .col-lg-7
            p.mb-4 Antes de poder renderizar nuestra escena, en Blender es necesario crear una cámara para poder tener el punto de vista en el cual convertimos la escena en imágenes.
            p.mb-0 A continuación, se aprenderá a poner las cámaras y a moverlas, para generar las vistas necesarias para la escena, construyendo el layout con ello. En los siguientes videos se ve cómo hacerlo de forma detallada:
          .col-lg-5
      ...
      .col-7
        .tema-1-anexo1
          a.anexo.mb-4(:href="obtenerLink('/downloads/prueba.pdf')" target="_blank")
            ...
            .anexo__texto
              p De igual manera en el documento enlazado se encuentra el paso a paso para conseguir el resultado esperado con el uso de la cámara blender:
        
    #t_1_3.titulo-segundo.color-acento-contenido
      h2 1.3 Movimientos de cámara y configuraciones

    p.mb-5 Con blender se puede generar movimientos de cámara de manera sencilla. A continuación, se mencionarán los movimientos de cámara y cómo realizarlos:<br><b>En los siguientes videos se verá cómo llevar los movimientos de cámara y configuraciones:</b>
    .tema-1.mb-5
      TabsB.color-acento-botones

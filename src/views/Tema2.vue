      ...
      .col-lg-10
        ...
        .row.justify-content-center.mb-5
          .col-lg-6.bordLineRr.p-4
            h3.text-center(style="color: #6BBCB1") #[em Idle]
          ...
          .col-lg-6.p-4
            h3.text-center(style="color: #6BBCB1") #[em Walk]
        ...
        .BG02.p-4.mb-4(style="background-color: #CCEFF7")
        ...
        h3.text-center.Color3.bordLineT.pt-5(style="color: #6BBCB1") #[em Attack]
        .row.justify-content-center
          .col-lg-10.mb-4
        ...
        h3.text-center.Color3.bordLineT.pt-5(style="color: #6BBCB1") #[em Dead]
        .row.justify-content-center
          .col-lg-10.mb-4
